...
class EmployerController extends Controller
{
    ...
    public function myJobsApplication(){
        $application = apply_job::query()->orderByDesc('created_at')->get();
        return view('Employer.my_jobs_applications',[
    ...
    public function postBlog(Request $request)
    {
        ...
        return redirect()->route('candidate.dashboard') ->with("Great! You have added a new blog");
