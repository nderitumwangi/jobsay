        ...
        <div class="container">
            <div class="page-title text-center text-white">
                <div class="heading-holder">
                    <h1 class="text-white">Edit Job</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="content col-md-8">
                    ...
                    <div class="post-padding">
                        ...
                        <hr>
                        <form id="submit" class="submit-form" method="post" enctype="multipart/form-data" action="{{route('job.update')}}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="company_name"
                                           required value="{{ old('company_name', $job->company_name )}}">
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="http://" name="company_website"
                                           required value="{{old('company_website',  $job->company_website) }}">
                                </div>
                            </div><!-- end row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="email" class="form-control" placeholder="" name="company_email"
                                           required value="{{ old('company_email', $job->company_email) }}" >
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" data-style="btn-default" data-live-search="true"
                                            name="job_category" value="{{ old('job_category', $job->job_category) }}">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="job_title"
                                           required value="{{ old('job_title', $job->job_title)}}">
                                </div>
                            </div><!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" data-style="btn-default" data-live-search="true"
                                            name="job_type" value="{{ old('job_type', $job->job_type )}}">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" data-style="btn-default" data-live-search="true"
                                            name="job_salary" value="{{ old('job_salary', $job->job_salary )}}">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input id="geocomplete" type="text" class="form-control"
                                           placeholder="Type in an address" name="job_location"
                                           required value="{{ old('job_location', $job->job_location )}}">
                                    <br>
                                </div>
                            </div><!-- end row -->

                            <hr class="invis">
                            <button class="btn btn-primary btn-block" value="Post">Update Form</button>
                        </form>
